    ...
    return (
        <section className="relative max-w-5xl md:min-h-[80vh] mx-auto px-4 py-24 overflow-hidden">
            <div className="text-center mb-16 animate-slide-up">
                ...
                <p className="text-muted-foreground max-w-xl mx-auto">Search Scope is designed to provide you with comprehensive SEO insights through advanced browser automation and AI.</p>
            </div>
