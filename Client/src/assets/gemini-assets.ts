// Response schema and prompts for structured SEO analysis
...
// Prompt generator function for getting SEO Analysis structured data from AI
export const generateSeoPrompt = (scrapedData: any) => `You are an expert SEO analyst. Analyze the following website data and provide a comprehensive SEO audit.
